...
const styles = StyleSheet.create({
  ...
  unit: { marginTop: 12, paddingTop: 8, borderTopWidth: 1, borderTopColor: "#ccc" },
  unitTitle: { fontSize: 12, fontWeight: 700 },
  pillRow: { flexDirection: "row", gap: 6, marginTop: 4, marginBottom: 6 },
  pill: { borderWidth: 0.5, borderColor: "#666", paddingVertical: 1, paddingHorizontal: 4, fontSize: 8 },
