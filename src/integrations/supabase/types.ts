  ...
  public: {
    Tables: {
      ...
      festival_concept_price_item: {
        ...
        Relationships: [
          {
            foreignKeyName: "festival_concept_price_item_concept_prices_id_fkey"
            columns: ["concept_prices_id"]
            isOneToOne: false
            referencedRelation: "festival_concept_prices"
            referencedColumns: ["id"]
          },
        ]
      }
      festival_concept_prices: {
        ...
        Relationships: [
          {
            foreignKeyName: "festival_concept_prices_concept_id_fkey"
            columns: ["concept_id"]
            isOneToOne: false
            referencedRelation: "concepts"
            referencedColumns: ["id"]
      ...
      festival_grocery_stall: {
        ...
        Relationships: [
          {
            foreignKeyName: "festival_grocery_stall_festival_id_fkey"
            columns: ["festival_id"]
            isOneToOne: false
            referencedRelation: "festivals"
            referencedColumns: ["id"]
      ...
      festival_grocery_stall_estimate: {
        ...
        Relationships: [
          {
            foreignKeyName: "festival_grocery_stall_estimate_festival_id_fkey"
            columns: ["festival_id"]
            isOneToOne: false
            referencedRelation: "festivals"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "festival_grocery_stall_estimate_stall_id_fkey"
            columns: ["stall_id"]
            isOneToOne: false
            referencedRelation: "festival_grocery_stall"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      festival_info_summaries: {
        ...
        Relationships: [
          {
            foreignKeyName: "festival_info_summaries_festival_id_fkey"
            columns: ["festival_id"]
            isOneToOne: true
            referencedRelation: "festivals"
            referencedColumns: ["id"]
      ...
      festival_trolley_group: {
        ...
        Relationships: [
          {
            foreignKeyName: "festival_trolley_group_festival_id_fkey"
            columns: ["festival_id"]
            isOneToOne: false
            referencedRelation: "festivals"
            referencedColumns: ["id"]
      ...
      festival_trolley_group_stall: {
        ...
        Relationships: [
          {
            foreignKeyName: "festival_trolley_group_stall_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "festival_trolley_group"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "festival_trolley_group_stall_stall_id_fkey"
            columns: ["stall_id"]
            isOneToOne: true
            referencedRelation: "festival_grocery_stall"
            referencedColumns: ["id"]
      ...
      grocery_festival_consumables: {
        ...
        Relationships: [
          {
            foreignKeyName: "grocery_festival_consumables_festival_id_fkey"
            columns: ["festival_id"]
            isOneToOne: false
            referencedRelation: "festivals"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "grocery_festival_consumables_ingredient_id_fkey"
            columns: ["ingredient_id"]
            isOneToOne: false
      ...
      grocery_recipe_packaging: {
        ...
        Relationships: [
          {
            foreignKeyName: "grocery_recipe_packaging_ingredient_id_fkey"
            columns: ["ingredient_id"]
            isOneToOne: false
            referencedRelation: "grocery_ingredients"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "grocery_recipe_packaging_recipe_id_fkey"
            columns: ["recipe_id"]
            isOneToOne: false
            referencedRelation: "grocery_recipes"
            referencedColumns: ["id"]
      ...
      grocery_stock_delivery: {
        Row: {
          ...
          packs: number
          pool_id: string
          source_order_festival_id: string | null
          source_order_supplier_id: string | null
          updated_at: string
        }
        Insert: {
          created_at?: string
        ...
        Relationships: [
          {
            foreignKeyName: "grocery_stock_delivery_ingredient_id_fkey"
            columns: ["ingredient_id"]
            isOneToOne: false
            referencedRelation: "grocery_ingredients"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "grocery_stock_delivery_pool_id_fkey"
            columns: ["pool_id"]
            isOneToOne: false
            referencedRelation: "grocery_stock_pool"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      grocery_stock_pool_festival: {
        ...
        Relationships: [
          {
            foreignKeyName: "grocery_stock_pool_festival_festival_id_fkey"
            columns: ["festival_id"]
            isOneToOne: false
            referencedRelation: "festivals"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "grocery_stock_pool_festival_pool_id_fkey"
            columns: ["pool_id"]
            isOneToOne: false
            referencedRelation: "grocery_stock_pool"
            referencedColumns: ["id"]
      ...
      grocery_stock_topup: {
        ...
        Relationships: [
          {
            foreignKeyName: "grocery_stock_topup_pool_id_fkey"
            columns: ["pool_id"]
            isOneToOne: false
            referencedRelation: "grocery_stock_pool"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "grocery_stock_topup_supplier_id_fkey"
            columns: ["supplier_id"]
            isOneToOne: false
            referencedRelation: "grocery_suppliers"
            referencedColumns: ["id"]
      ...
      grocery_stock_topup_item: {
        ...
        Relationships: [
          {
            foreignKeyName: "grocery_stock_topup_item_ingredient_id_fkey"
            columns: ["ingredient_id"]
            isOneToOne: false
            referencedRelation: "grocery_ingredients"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "grocery_stock_topup_item_topup_id_fkey"
            columns: ["topup_id"]
            isOneToOne: false
            referencedRelation: "grocery_stock_topup"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      staff_station_skill: {
        ...
        Relationships: [
          {
            foreignKeyName: "staff_station_skill_staff_id_fkey"
            columns: ["staff_id"]
            isOneToOne: false
            referencedRelation: "staff"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "staff_station_skill_station_id_fkey"
            columns: ["station_id"]
            isOneToOne: false
            referencedRelation: "station"
            referencedColumns: ["id"]
      ...
      station: {
        ...
        Relationships: [
          {
            foreignKeyName: "station_concept_id_fkey"
            columns: ["concept_id"]
            isOneToOne: false
            referencedRelation: "concepts"
            referencedColumns: ["id"]
