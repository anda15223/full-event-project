  ...
  try {
    ...
    const { fileUrl, documentType, context } = body as {
      ...
      context?: {
        ...
        concept_name?: string;
        concept_slug?: string;
        tent_mates?: Array<{ name?: string; slug?: string }>;
      };
    };
    ...
    if (
      context &&
      (context.festival_start ||
        context.festival_end ||
        context.festival_name ||
        context.concept_name ||
        context.concept_slug ||
